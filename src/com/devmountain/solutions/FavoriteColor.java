...
public class FavoriteColor {
    ...
    char lastInitial = 'N';
    int age = 1;
    long ageOfEarth = 45300000000L;
    float massOfSilicon = 28.0855f;
    ...
    String firstName = "YOUR_FIRST_NAME";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("What does " + favoriteColor + " look like?"); //Just an example, don't worry if yours is different
        String description = input.nextLine(); //Storing the next input within a new variable

        System.out.println("Hmm... I realize now that I don't know what " + description + " looks like either." );
        ...
        //notice how IntelliJ highlights the double equals sign? This would produce a bug if favoriteColor is null.
        ...
        //The conditional should be re-written using the equals method. You will learn more about this in the weeks to come
